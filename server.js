...
const os = require("os");
const axios = require("axios"); // To fetch the public IP
...
// Fetch and log the public IP for external access
async function logServerURL() {
  try {
...
app.listen(PORT, "0.0.0.0", async () => {
  console.log(
    `Server is running on all network interfaces (0.0.0.0) at port ${PORT}`
  );
  await logServerURL();
});
      ...
      lessons: [
        {
          ...
          content: "Dive deep into React Hooks and their use cases",
        },
        {
          title: "State Management with Redux",
          content: "Learn how to manage complex state with Redux",
        },
      ],
    },
    {
      ...
      lessons: [
        {
          ...
          content: "Learn how to set up a Node.js environment",
        },
        {
          title: "Building APIs with Express",
          content: "Learn how to create APIs using Express.js",
        },
      ],
    },
    {
      ...
      lessons: [
        {
          ...
          content: "Learn the components of the MERN stack",
        },
        {
          title: "Building a Full Stack Application",
          content: "Learn how to create a full stack app with MERN",
        },
      ],
    },
    {
      ...
      lessons: [
        {
          ...
          content: "Learn about supervised learning algorithms",
        },
        {
          title: "Unsupervised Learning",
          content: "Understand unsupervised learning techniques",
        },
      ],
    },
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          content: "Understand how to use CSS to style web pages",
        },
      ],
    },
    {
      ...
      lessons: [
        {
          title: "AWS Overview",
          content: "Learn about the basics of AWS and cloud computing",
        },
        {
          title: "Building a Web App on AWS",
          content: "Learn how to deploy a simple app using AWS",
        },
      ],
    },
    {
      ...
      description:
        "Learn about common data structures and algorithms for coding interviews",
      instructor: "Olivia Wilson",
      lessons: [
        {
          title: "Arrays and Linked Lists",
          content: "Learn about arrays and linked lists",
        },
        {
          title: "Sorting Algorithms",
          content: "Understand different sorting algorithms",
        },
      ],
    },
    {
      ...
      description:
        "Learn the fundamentals of digital marketing and social media strategies",
      instructor: "Lucas Brown",
      lessons: [
        {
          title: "Introduction to Digital Marketing",
          content: "Learn about digital marketing channels",
        },
        {
          title: "Social Media Marketing",
          content: "Understand the importance of social media in marketing",
        },
      ],
    },
  ];
